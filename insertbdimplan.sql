...
(null, 'Chiri', 'Lopez', 'Gomez'),
(null, 'Cris', 'Mendez', 'Morales'),
(null, 'Alan', 'Reyes', 'Abarca'),
(null, 'Angel', 'Montes', 'Guizar'),
(null, 'Eugenia', 'Uribe', 'Panti'),
(null, 'Cristina', 'Jimenez', 'Castañeda');
...
(1, 'S2P25', '2', 1, 'Familia Morales Panigua', 25, 1, 1, 6, POINT(19.2608, 99.0829), 'CAPILLA DE COLOR BLANCO, POSEE PUERTA Y VENTANAS DE HERRERÍA COLOR NEGRO, PRESENTA DETALLES NEOGÓTICOS', 'AL NORTE COLINDA CON MONUMENTO HISTÓRICO'),
(null, 'S1P20', '1', 2, 'Familia Ruiz Garcia', 20, 2, 1, 5, POINT(20.2618, 98.0139), 'CAPILLA DE COLOR ROSADO', 'A LADO DE UN OXXO'),
(null, 'S3P22', '3', 3, 'Familia Perez Lopez', 22, 3, 1, 4, POINT(20.3015, 98.3040), 'CAPILLA DE COLOR VERDE', 'A LADO DE LA CAPILLA VERDE'),
(null, 'S4P26', '4', 4, 'Familia Guizar Garcia', 26 , 4, 1, 7, POINT(20.2217, 98.6012), 'CAPILLA DE COLOR ROJO', 'A LADO DE UNA FERRETERIA'),
(null, 'S5P28', '5', 5, 'Familia Jimenez Castañeda', 28, 5, 1, 6, POINT(20.1639, 98.1015), 'CAPILLA DE COLOR AZUL', 'A LADO LA CAPILLA AMARILLA'),
(null, 'S6P35', '6', 6, 'Familia Ramirez Mendez', 35, 6, 1, 4, POINT(20.1012, 98.1567), 'CAPILLA DE COLOR AMARILLO', 'A LADO LA CAPILLA NARANJA'),
(null, 'S7P15', '7', 7, 'Familia Guillen Garcia', 15, 7, 1, 2, POINT(20.0210, 98.7012), 'CAPILLA DE COLOR NARANJA', 'A LADO DE UNA FARMACIA'),
(null, 'S8P32', '8', 8, 'Familia Montes Ordoñez', 32, 8, 1, 8, POINT(20.4012, 98.8022), 'CAPILLA DE COLOR CAFE', 'A LADO DE UNA CASA ABANDONADA');
...
FROM c_inhumado 
INNER JOIN m_tumba ON c_inhumado.cv_inhumado = m_tumba.cv_tumba;
